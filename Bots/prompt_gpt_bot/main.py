...
async def start(update, context):
    await update.message.reply_text("Привет, я бот, который помогает создать подробный и эффективный промт под любую задачу для любой нейросети. Напиши свой запрос и начнем работу")
